...
$app.strings = {
  "vi": {
    "starterror": "Không hỗ trợ chạy kiểu này",
    "ftypeerror": " không phải là tệp ipa",
    "installtitle": "Đang cài đặt...",
    "installmsg": "\n\nBạn có thể kiểm tra ở màn hình chính.\nHãy bấm  \"Done\" sau khi hoàn tất.",
    "inerrtitle": "Lỗi khi nhập tệp IPA",
    "inerrmsg": "Hãy chạy lại Script"
  },
  "en": {
